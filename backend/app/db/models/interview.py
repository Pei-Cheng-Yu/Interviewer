...
class InterviewSession(Base):
    ...
    status: Mapped[str] = mapped_column(default="active", nullable=False)  # active, completed
...
class InterviewInteraction(Base):
    ...
    reference_data: Mapped[Optional[dict[str, Any]]] = mapped_column(JSON, nullable=True)
